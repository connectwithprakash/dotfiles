...
#
# Run this script after a fresh macOS install to set sensible defaults.
...
echo "Some preferences require sudo access."
sudo -v
...
echo "macOS preferences applied. Some changes require a logout/restart to take effect."
